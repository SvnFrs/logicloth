    ...
    <body>
        ...
        <main>
            ...
            <div class="container-xxl py-5">
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${restaurants}" var="restaurant">
                                    <tr>
                                        ...
                                        <td class="w-25">
                                            <div class="my-1">
                                                <a href="" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#restaurant-detail-modal-${restaurant.restaurantID}">Thông tin</a>
                                            </div>
                                            <div class="my-1">
                                                <a href="" class="btn btn-sm btn-primary"
                                                   data-bs-toggle="modal" data-bs-target="#restaurant-update-modal-${restaurant.restaurantID}"
                                                >Chỉnh sửa quán ăn</a>
                                            </div>
                                            <div class="my-1">
                ...
                <c:forEach items="${restaurants}" var="restaurant">
                    <div class="modal fade" id="restaurant-detail-modal-${restaurant.restaurantID}" tabindex="-1" aria-labelledby="restaurant-detail-modal-${restaurant.restaurantID}Label" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="restaurant-detail-modal-${restaurant.restaurantID}Label">${restaurant.restaurantName}</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="input-group">
                                                <input type="text" class="form-control" value="${restaurant.restaurantDescription}" disabled aria-label="Username" aria-describedby="basic-addon1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <table class="table table-striped align-middle">
                                                ...
                                                <tbody>
                                                <c:forEach items="${saleDAOs.getAllSaleIDByRestaurantID(restaurant.restaurantID)}" var="saleID">
                ...
                <c:forEach items="${restaurants}" var="restaurant">
                    <div class="modal fade" id="restaurant-update-modal-${restaurant.restaurantID}" tabindex="-1" aria-labelledby="restaurant-update-modal-${restaurant.restaurantID}" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Chỉnh sửa thông tin <span class="text-success fs-4">${restaurant.restaurantName}</span></h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form class="my-3">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="mb-3">
                                                    <label for="restaurant-update-name-${restaurant.restaurantID}" class="form-label">Tên quán ăn</label>
                                                    <input type="text" class="form-control" id="restaurant-update-name-${restaurant.restaurantID}"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="mb-3">
                                                    <label for="restaurant-update-address-${restaurant.restaurantID}" class="form-label">Địa chỉ</label>
                                                    <input type="text" class="form-control" id="restaurant-update-address-${restaurant.restaurantID}"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                <label for="restaurant-update-description-${restaurant.restaurantID}" class="form-label">Product description</label>
                                                <textarea class="form-control" id="restaurant-update-description-${restaurant.restaurantID}" rows="3"
                                ...
                                <div class="modal-footer">
                                    <div class="row">
                                        <div class="col-12">
                                            <button type="button" class="btn btn-primary" onclick="updateRestaurant(${restaurant.restaurantID})">Update</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
